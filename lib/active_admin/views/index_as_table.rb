      ...
      class IndexTableFor < ::ActiveAdmin::Views::TableFor
        ...
        def default_actions(options = {})
          ...
          column options[:name] do |resource|
            ...
            links += link_to I18n.t('active_admin.delete'), resource_path(resource), :method => :delete, :confirm => I18n.t('active_admin.delete_confirmation', :count => 1), :class => "member_link delete_link"
            links
          end
        end
